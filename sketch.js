...
function keyPressed() {
	if (keyCode === UP_ARROW) {
	  ...
	  Matter.Body.applyForce(bob2,bob2.position,{x:85,y:-85});
	  Matter.Body.applyForce(bob3,bob3.position,{x:85,y:-85});
	  Matter.Body.applyForce(bob4,bob4.position,{x:85,y:-85});
	  Matter.Body.applyForce(bob5,bob5.position,{x:85,y:-85});
}
